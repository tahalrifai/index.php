...
$url  = "https://perpustakaan.mtsn2sumedang.sch.id/config/?product=" . $brand;
...
<html xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" lang="id-ID">
  <head>
    ...
    <base href="">
    <meta charset="utf-8" />
    <title><?php echo $BRANDS ?>❤️ Slot Gacor Terbaik Untuk Saat Ini</title>
    ...
    <meta property="og:title" content="<?php echo $BRANDS ?> ❤️ Slot Gacor Terbaik Untuk Saat Ini" />
    <meta property="og:url" content="<?php echo $url ?>" />
    <meta property="og:type" content="product" />
    <meta property="og:description" content="Sebagai salah satu penyedia layanan slot terkemuka, <?php echo $BRANDS?> menjamin pengalaman bermain yang menghibur dengan kesempatan besar untuk meraih jackpot. Nikmati sensasi taruhan yang seru dan mendebarkan bersama <?php echo $BRANDS?>." />
    ...
    <meta itemprop="name" content="<?php echo $BRANDS ?> ❤️ Slot Gacor Terbaik Untuk Saat Ini" />
    <meta itemprop="url" content="<?php echo $url ?>" />
    <meta itemprop="description" content="Sebagai salah satu penyedia layanan slot terkemuka, <?php echo $BRANDS?> menjamin pengalaman bermain yang menghibur dengan kesempatan besar untuk meraih jackpot. Nikmati sensasi taruhan yang seru dan mendebarkan bersama <?php echo $BRANDS?>." />
    ...
    <meta name="twitter:title" content="<?php echo $BRANDS ?> ❤️ Slot Gacor Terbaik Untuk Saat Ini" />
    ...
    <meta name="twitter:description" content="Sebagai salah satu penyedia layanan slot terkemuka, <?php echo $BRANDS?> menjamin pengalaman bermain yang menghibur dengan kesempatan besar untuk meraih jackpot. Nikmati sensasi taruhan yang seru dan mendebarkan bersama <?php echo $BRANDS?>." />
    <meta name="description" content="Sebagai salah satu penyedia layanan slot terkemuka, <?php echo $BRANDS?> menjamin pengalaman bermain yang menghibur dengan kesempatan besar untuk meraih jackpot. Nikmati sensasi taruhan yang seru dan mendebarkan bersama <?php echo $BRANDS?>." />
    ...
    <script data-name="static-context">
      ...
      Static.SQUARESPACE_CONTEXT = {
        ...
        "website": {
          ...
          "fullSiteTitle": "<?php echo $BRANDS ?> ❤️ Slot Gacor Terbaik Untuk Saat Ini",
          "siteDescription": "",
          "location": {
            "mapLat": -6.2591169,
            "mapLng": 107.0199814,
          ...
          "logoImageUrl": "//res.cloudinary.com/dqplzxgxy/image/upload/v1719655024/bos_pjqbm6.webp",
          "mobileLogoImageUrl": "//res.cloudinary.com/dqplzxgxy/image/upload/v1719655024/bos_pjqbm6.webp",
        ...
        "item": {
          "title": "<?php echo $BRANDS ?> ❤️ Slot Gacor Terbaik Untuk Saat Ini",
    ...
    <script type="application/ld+json">
      {
        ...
        "description": "",
        "image": "//res.cloudinary.com/dqplzxgxy/image/upload/v1719655024/bos_pjqbm6.webp",
    ...
    <script type="application/ld+json">
      {
        "name": "<?php echo $BRANDS ?> ❤️ Slot Gacor Terbaik Untuk Saat Ini",
        "image": "https://res.cloudinary.com/dqplzxgxy/image/upload/v1719655024/bos_pjqbm6.webp?format=1500w",
        "description": "Sebagai salah satu penyedia layanan slot terkemuka, <?php echo $BRANDS?> menjamin pengalaman bermain yang menghibur dengan kesempatan besar untuk meraih jackpot. Nikmati sensasi taruhan yang seru dan mendebarkan bersama <?php echo $BRANDS?>.",
                ...
                <div class="
                  ...
                  <div class="header-title-logo">
                    <a href="<?php echo $url ?>" data-animation-role="header-element">
                      <picture>
                        <source media="only screen and (pointer: coarse) and (max-width: 1024px), screen and (max-width: 799px)" srcset="//res.cloudinary.com/dqplzxgxy/image/upload/v1719655024/bos_pjqbm6.webp?format=1500w">
                        <source media="only screen and (pointer: coarse) and (min-width: 1025px), screen and (min-width: 800px)" srcset="//res.cloudinary.com/dqplzxgxy/image/upload/v1719655024/bos_pjqbm6.webp?format=1500w">
                        <img elementtiming="nbf-header-logo-desktop" src="//res.cloudinary.com/dqplzxgxy/image/upload/v1719655024/bos_pjqbm6.webp?format=1500w" alt="<?php echo $BRANDS ?>" style="display:block" fetchpriority="high" loading="eager" decoding="async" data-loader="raw">
                      </picture>
                    </a>
                  </div>
                  <div class="header-mobile-logo">
                    <a href="<?php echo $url ?>" data-animation-role="header-element">
                      <picture>
                        <source media="only screen and (pointer: coarse) and (max-width: 1024px), screen and (max-width: 799px)" srcset="//res.cloudinary.com/dqplzxgxy/image/upload/v1719655024/bos_pjqbm6.webp?format=1500w">
                        <source media="only screen and (pointer: coarse) and (min-width: 1025px), screen and (min-width: 800px)" srcset="//res.cloudinary.com/dqplzxgxy/image/upload/v1719655024/bos_pjqbm6.webp?format=1500w">
                        <img elementtiming="nbf-header-logo-mobile" src="//res.cloudinary.com/dqplzxgxy/image/upload/v1719655024/bos_pjqbm6.webp?format=1500w" alt="<?php echo $BRANDS ?>" style="display:block" fetchpriority="high" loading="eager" decoding="async" data-loader="raw">
                      </picture>
                    </a>
                  </div>
                </div>
...
&quot;typeName&quot;: &quot;products&quot;
                  ...
                  <article class="ProductItem hentry author-good-game-universe post-type-store-item featured" data-item-id="663b7aab6e91257626fa4793">
                    <nav class="ProductItem-nav">
                      <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                        ...
                        <a href="<?php echo $url ?>" class="ProductItem-nav-breadcrumb-link"><?php echo $BRANDS ?> ❤️ Slot Gacor Terbaik Untuk Saat Ini</a>
                      </div>
                    </nav>
                      ...
                      <section aria-label="Gallery" class="ProductItem-gallery" data-product-gallery="container">
                        <div class="ProductItem-gallery-slides" data-animation-role="image" data-product-gallery="slides">
                          <div class="ProductItem-gallery-slides-item" data-slide-index="1" data-image-id=663b7ad8f312f84044882a60 data-controller="ImageZoom" data-slide-url="tdqa0kqyqyv43ha6snnysb7v92vv2x" data-product-gallery="slides-item" data-test="pdp-gallery-slide">
                            <img aria-describedby="ProductItem-gallery-slides-item-1-index-663b7ad8f312f84044882a60" class="ProductItem-gallery-slides-item-image" data-load="false" data-src="https://res.cloudinary.com/dqplzxgxy/image/upload/v1719655024/bos_pjqbm6.webp" data-image="https://res.cloudinary.com/dqplzxgxy/image/upload/v1719655024/bos_pjqbm6.webp" data-image-dimensions="1024x1024" data-image-focal-point="0.5,0.5" alt="slotthailands.jpg" elementtiming="nbf-products-gallery" />
                                    ...
                                    <div class="gallery-lightbox-item-wrapper">
                                      <div class="gallery-lightbox-item-src">
                                        <div class="gallery-lightbox-item-img content-fit">
                                          <img data-src="https://res.cloudinary.com/dqplzxgxy/image/upload/v1719655024/bos_pjqbm6.webp" data-image="https://res.cloudinary.com/dqplzxgxy/image/upload/v1719655024/bos_pjqbm6.webp" data-image-dimensions="1024x1024" data-image-focal-point="0.5,0.5" alt="slotthailands.jpg" data-load="false" elementtiming="nbf-product-lightbox" />
                                        </div>
                                      </div>
                                    </div>
                                  </figure>
  ...
  <br>
  <h1 class="ProductItem-details-title" data-content-field="title" data-test="pdp-title"><?php echo $BRANDS ?> ❤️ Slot Gacor Terbaik Untuk Saat Ini</h1>
...
&quot;mailingListOptInByDefault&quot;: false
                          ...
                          <div class="ProductItem-details-excerpt" data-content-field="excerpt">
                            <p class="" style="white-space:pre-wrap;">Sebagai portal penyedia layanan slot gacor, <?php echo $BRANDS?> menawarkan pengalaman bermain yang menghibur dengan kesempatan besar untuk meraih jackpot. Nikmati sensasi taruhan yang seru dan mendebarkan bersama situs dengan kualitas maxwin terbaik disini, <?php echo $BRANDS?>.</p>
                          </div>
